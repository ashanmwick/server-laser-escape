...
export declare const Protocol: {
    ...
    readonly PING: 18;
    readonly ROOM_INPUT_RELIABLE: 19;
    readonly ROOM_INPUT_UNRELIABLE: 20;
    readonly ROOM_REQUEST: 21;
    readonly ROOM_RESPONSE: 22;
};
 ...
 */
export declare const ProtocolModifier: {
    /**
...
export declare const PROTOCOL_CODE_MASK = 31;
...
export declare const PROTOCOL_MODIFIER_MASK = 224;
/**
 ...
 */
export declare const HandshakeSection: {
    /**
