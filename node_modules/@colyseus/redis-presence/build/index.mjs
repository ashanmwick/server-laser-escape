...
var RedisPresence = class {
  ...
  resubscribeAll() {
    ...
    this.sub.subscribe(...topics).catch((e) => logger.warn("RedisPresence: failed to re-subscribe:", e.message));
  }
   ...
   */
  async brpop(...args) {
    const blocking = this.pub instanceof Cluster ? this.pub.duplicate([]) : this.pub.duplicate();
    try {
