import { type Type, Deferred, type RemoteRoomCallReturn } from './utils/Utils.ts';
 ...
 */
export declare function findRoomsByIds(roomIds: string[]): Promise<Map<string, IRoomCache>>;
/**
 ...
 */
export declare function remoteRoomCall<TRoom = Room, TMethod extends keyof TRoom = keyof TRoom>(roomId: string, method: TMethod, args?: any[], rejectionTimeout?: number): Promise<RemoteRoomCallReturn<TRoom, TMethod>>;
export declare function remoteRoomCall<TRoom = Room>(roomId: string, method: keyof TRoom, args?: any[], rejectionTimeout?: number): Promise<any>;
