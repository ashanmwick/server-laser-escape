...
var nullProto = (_, value) => value && typeof value === "object" && !Array.isArray(value) ? Object.assign(/* @__PURE__ */ Object.create(null), value) : value;
function getDevModeCache() {
  return JSON.parse(import_fs.default.readFileSync(DEVMODE_CACHE_FILE_PATH, "utf8"), nullProto) || {};
}
