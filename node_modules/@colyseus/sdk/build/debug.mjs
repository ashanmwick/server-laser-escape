...
import { loadPreferences, applyPanelPosition, preferences, savePreferences, roomDebugInfo, getDebugRoot, repositionDebugPanels, authInstances } from './debug/core.mjs';
import { initLayout, onReflow } from './debug/layout.mjs';
import { calculateRates, updateDebugPanel, initialize } from './debug/panel.mjs';
import { positionPredictContainer, onPredictPublished } from './debug/predict.mjs';
...
function jitteredDelay(base, jit, cursor) {
    if (!preferences.latencySimulation.enabled || (base <= 0 && jit <= 0))
        return -1;
