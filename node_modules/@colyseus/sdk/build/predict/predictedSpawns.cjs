...
class PredictedSpawns {
    constructor(opts = {}, clock = null) {
        ...
        this.readServer = (server, field) => server[field];
        this.opts = opts;
        this.clock = clock;
        this.correlate = (_a = opts.correlate) !== null && _a !== void 0 ? _a : "fifo";
        this.ttl = (_b = opts.ttl) !== null && _b !== void 0 ? _b : predictedEvents.DEFAULT_TTL_POLICY;
    }
    /**
    ...
    attach(subscribe) {
        var _a;
        (_a = this.detach) === null || _a === void 0 ? void 0 : _a.call(this);
    ...
    prune() {
        ...
        const now = this.now();
        const ttl = this.ttl((_b = (_a = this.clock) === null || _a === void 0 ? void 0 : _a.smoothedRtt()) !== null && _b !== void 0 ? _b : 0);
        for (const entry of this.byId.values()) {
            ...
            if (entry.state === "pending" && !entry.accepted && entry.at !== undefined && now - entry.at > ttl) {
                this.byId.delete(entry.id);
                (_d = (_c = this.opts).onReject) === null || _d === void 0 ? void 0 : _d.call(_c, entry.local, entry.id);
            }
        }
    }
    ...
    now() {
        var _a, _b;
        return (_b = (_a = this.clock) === null || _a === void 0 ? void 0 : _a.serverNow()) !== null && _b !== void 0 ? _b : performance.now();
    }
}

exports.PredictedSpawns = PredictedSpawns;
//# sourceMappingURL=predictedSpawns.cjs.map
