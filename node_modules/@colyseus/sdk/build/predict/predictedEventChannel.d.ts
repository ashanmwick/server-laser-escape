 ...
 */
import { type PredictedEventsClock } from "./predictedEvents.ts";
import { type PredictSink } from "./rollback.ts";
...
export declare const DEFAULT_GRACE_TICKS = 10;
...
export declare class PredictedEventChannel<T> implements PredictSink<T> {
