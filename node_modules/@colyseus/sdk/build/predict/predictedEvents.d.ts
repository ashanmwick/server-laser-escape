 ...
 */
export declare const DEFAULT_TTL_POLICY: (rtt: number) => number;
...
export declare class PredictedEvents<K = string> {
    /**
     ...
     */
    static get<K = string>(room: {
        clock?: PredictedEventsClock | null;
    }, opts?: PredictedEventsGetOptions<K>): PredictedEvents<K>;
    private entries;
