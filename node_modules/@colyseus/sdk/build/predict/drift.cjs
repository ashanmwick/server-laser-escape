 ...
 * ~0") when it isn't.
 */
function classifyDrift(d, tolerance) {
...
exports.newDrift = newDrift;
exports.resetDrift = resetDrift;
exports.updateDrift = updateDrift;
//# sourceMappingURL=drift.cjs.map
