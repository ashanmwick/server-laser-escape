...
//
// colyseus.js@0.18.2
import { sizedIcon, networkIcon, keyIcon, copyIcon, settingsIcon, eyeSlashIcon } from './icons.mjs';
import { roomDebugInfo, preferences, latencyRamp, getDebugRoot, getBorderColor, savePreferences, authInstances, hidePanelsForSession, setCompactMenuOpen, setCompactRevealed, isCompactRevealed } from './core.mjs';
import { verticalEdge, horizontalEdge } from './geometry.mjs';
import { reflow, isCompact } from './layout.mjs';
import { applySegmentedState, bindSegmentedHover } from './tokens.mjs';
...
function createMenu(logoContainer) {
    ...
    function getAuthToken() {
        var t = null;
        authInstances.forEach(function (a) { if (!t && a.token) {
            t = a.token;
        } });
        if (t) {
            return t;
    ...
    clearBtn.addEventListener('click', function (e) {
        ...
        authInstances.forEach(function (a) { if (a.token) {
            void a.signOut();
        } });
        try {
