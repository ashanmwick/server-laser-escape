...
function setMaxViewportHeight(el, vhExpression) {
    el.style.maxHeight = vhExpression;
    el.style.maxHeight = vhExpression.replace(/vh\b/g, 'dvh');
}

exports.EDGE_INSET = EDGE_INSET;
exports.clearEdges = clearEdges;
exports.horizontalEdge = horizontalEdge;
exports.setInset = setInset;
exports.setMaxViewportHeight = setMaxViewportHeight;
