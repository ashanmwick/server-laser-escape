...
function openSendMessagesModal(uniquePanelId) {
    ...
    var existingModal = core.getDebugRoot().getElementById('debug-send-messages-modal');
    if (existingModal) {
    ...
    const modal$1 = modal.createModal({
    ...
    modal$1.appendChild(headerComponents.header);
    // Make modal draggable
    modal.makeDraggable(modal$1, headerComponents.header);
    ...
    modal$1.appendChild(formContainer);
    core.getDebugRoot().appendChild(modal$1);
}

exports.openSendMessagesModal = openSendMessagesModal;
