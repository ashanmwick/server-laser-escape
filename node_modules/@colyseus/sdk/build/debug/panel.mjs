...
import { logoIcon, resizeIcon, infoIcon, sizedIcon, treeViewIcon, messageIcon, disconnectIcon, envelopeUp, envelopeDown, jitterIcon } from './icons.mjs';
import { isPanelsHidden, getBorderColor, preferences, applyPanelPosition, getDebugRoot, roomDebugInfo, getPanelStack, PREDICT_CONTAINER_ID, setCompactRevealed, repositionDebugPanels, formatBytes } from './core.mjs';
import { isCoarsePointer, isCompact, onReflow } from './layout.mjs';
import { createMenu } from './menu.mjs';
import { openSendMessagesModal } from './send-message.mjs';
import { openStateInspectorModal } from './state-inspector.mjs';
...
function createDebugPanel(uniquePanelId, debugInfo) {
    ...
    var stateBtn = createActionButton('debug-state-btn-' + uniquePanelId, treeViewIcon, 'State', function () { openStateInspectorModal(uniquePanelId); });
    var messageBtn = createActionButton('debug-message-btn-' + uniquePanelId, messageIcon, 'Send', function () { openSendMessagesModal(uniquePanelId); });
    ...
    var disconnectBtn = createActionButton('debug-disconnect-btn-' + uniquePanelId, disconnectIcon, 'Drop', function () {
...
function bindTooltipDismiss() {
    document.addEventListener('click', function () {
        var tooltips = getDebugRoot().querySelectorAll('[id^="debug-tooltip-"]');
...
function watchPanelShape() {
    ...
    onReflow(function (state) {
        ...
        var panels = getDebugRoot().querySelectorAll('[id^="debug-panel-"]');
...
export { calculateRates, createDebugPanel, drawGraph, initialize, updateDebugPanel };
