 ...
 */
function applySegmentedState(button, active) {
...
function bindSegmentedHover(button, onEnter, onLeave) {
    button.addEventListener("mouseenter", function () {
        if (button.dataset.active !== "true") {
            button.style.background = SEGMENT.hover;
        }
        onEnter === null || onEnter === void 0 ? void 0 : onEnter();
    });
    button.addEventListener("mouseleave", function () {
        if (button.dataset.active !== "true") {
            button.style.background = SEGMENT.background;
        }
...
exports.applySegmentedState = applySegmentedState;
exports.bindSegmentedHover = bindSegmentedHover;
