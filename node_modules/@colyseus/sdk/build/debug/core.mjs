...
//
// colyseus.js@0.18.2
import { horizontalEdge, verticalEdge, clearEdges, setInset, EDGE_INSET, setMaxViewportHeight } from './geometry.mjs';
import { isCompact } from './layout.mjs';
import { injectBaseStyles } from './styles.mjs';
...
export { PREDICT_CONTAINER_ID, applyOverlayVisibility, applyPanelPosition, authInstances, formatBytes, getBorderColor, getDebugRoot, getPanelStack, hidePanelsForSession, isCompactRevealed, isOverlayVisible, isPanelsHidden, latencyRamp, loadPreferences, preferences, repositionDebugPanels, roomDebugInfo, savePreferences, setCompactMenuOpen, setCompactRevealed };
