...
let state = { compact: false, coarse: false };
...
exports.isCoarsePointer = isCoarsePointer;
exports.isCompact = isCompact;
exports.onReflow = onReflow;
