...
class H3TransportTransport {
    ...
    frame(data) {
        ...
        const prefixLength = schema.encode.number(this.lengthPrefixBuffer, bytes.length, { offset: 0 });
    ...
    close(code, reason) {
        ...
        try {
            ...
            const ret = (_a = this.wt) === null || _a === void 0 ? void 0 : _a.close({ closeCode: code, reason: reason });
